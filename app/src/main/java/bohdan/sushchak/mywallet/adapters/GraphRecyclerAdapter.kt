...
class GraphRecyclerAdapter(val context: Context, items: List<GraphItem>) : BaseRecyclerAdapter<GraphRecyclerAdapter.ViewHolder, GraphItem>(items) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GraphRecyclerAdapter.ViewHolder {
